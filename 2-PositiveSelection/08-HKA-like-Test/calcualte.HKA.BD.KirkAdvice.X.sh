...
python ${SCRIPT_DIR}/SlidWin-HKA-like-Test.BD.AltAllelMW_KirkAdvice.py ../bsve_bcbr_chr${i}_TrimAlt_Annot_Mask_Filter.vcf.gz \
100000 10000 chr${i} > bsve_AltAllelMW_chr${i}_TrimAlt_Annot_Mask_Filter.HKA.KirkAdvice.txt
echo '********** Done calculating HKA-like test ***********'

echo '********** Extracting genes within windows ***********'
python ${SCRIPT_DIR}/Genes_within_HKA.py bsve_AltAllelMW_chr${i}_TrimAlt_Annot_Mask_Filter.HKA.KirkAdvice.txt ${OrtoBed}
