...
python ${SCRIPT_DIR}/SlidWin-HKA-like-Test.BD.py bsve_joint_chr${i}_TrimAlt_Annot_Mask_Filter.vcf.gz \
...
python ${SCRIPT_DIR}/Genes_within_HKA.MW.py bsve_joint_chr${i}_TrimAlt_Annot_Mask_Filter.HKA.txt ${OrtoBed}
