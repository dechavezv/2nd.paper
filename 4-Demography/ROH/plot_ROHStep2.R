...
mylabels=c("MW Capt.","Crab-eat fox","MW 370", "MW 383",
...
axis(side=2, line=.5)
axis(side=1, labels=c("Ethiopia","Crab-eating fox","Hoary fox","Pampas fox", "Andean fox", "Maned wolf", "Bush dog"), at=seq(1,7), las=2)
