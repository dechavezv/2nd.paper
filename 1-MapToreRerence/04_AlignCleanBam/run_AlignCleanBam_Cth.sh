...
#$ -l highmem,h_rt=80:00:00,h_data=20G,highp,h_vmem=100G
#$ -o /u/home/d/dechavez/project-rwayne/Cth/reads/log/AlignClean.out
#$ -e /u/home/d/dechavez/project-rwayne/Cth/reads/log/AlignClean.err
#$ -pe shared 4
#$ -m abe
#$ -M dechavezv
#$ -N Align
...
TEMP_DIR=/u/home/d/dechavez/project-rwayne/Cth/reads/temp/${FILENAME}
