...
#$ -l h_rt=32:00:00,h_data=8G,highp,h_vmem=40G
#$ -o /u/home/d/dechavez/project-rwayne/Clup/reads/TG/log/AlignClean.out
#$ -e /u/home/d/dechavez/project-rwayne/Clup/reads/TG/log/AlignClean.err
#$ -pe shared 2
#$ -m abe
#$ -M dechavezv
#$ -N Align
