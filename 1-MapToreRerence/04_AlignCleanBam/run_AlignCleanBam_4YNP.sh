...
#$ -l h_rt=28:00:00,h_data=6G,highp,h_vmem=15G
#$ -o /u/scratch/d/dechavez/YNP_4Genomes/log/AlignClean.out
#$ -e /u/scratch/d/dechavez/YNP_4Genomes/log/AlfignClean.err
#$ -pe shared 4
#$ -m abe
#$ -M dechavezv
#$ -N Align
...
TEMP_DIR=/u/scratch/d/dechavez/YNP_4Genomes/temp/${FILENAME}
