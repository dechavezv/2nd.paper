...
#$ -o /u/home/d/dechavez/project-rwayne/Lvet/log/AlignClean.human.out
#$ -e /u/home/d/dechavez/project-rwayne/Lvet/log/AlignClean.human.err
#$ -pe shared 8
#$ -m abe
#$ -M dechavezv
#$ -N Align
...
REFERENCE=/u/home/d/dechavez/project-rwayne/hg19/hg19.fa
...
TMP_DIR=${TEMP_DIR} 2>>./"Process_"${FILENAME}"_SamToFastq.human.txt" | \
bwa mem -M -t 8 -p ${REFERENCE} /dev/stdin 2>>./"Process_"${FILENAME}"_BwaMem.human.txt" | \
java -Xmx6G -jar -Djava.io.tmpdir=${TEMP_DIR} \
...
TMP_DIR=${TEMP_DIR} 2>>./"Process_"${FILENAME}"_MergeBam.${FILENAME}.human.txt"
