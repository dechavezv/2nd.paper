...
-trimAlternates \
-V Lve01_chr$(printf "%02d" "$SGE_TASK_ID").vcf.gz \
-o Lve01_chr$(printf "%02d" "$SGE_TASK_ID")_TrimAlt.vcf.gz
...
-A AlleleBalance \
-L chr$(printf %02d $SGE_TASK_ID) \
-V Lve01_chr$(printf "%02d" "$SGE_TASK_ID")_TrimAlt.vcf.gz \
-o Lve01_chr$(printf "%02d" "$SGE_TASK_ID")_TrimAlt_Annot.vcf.gz 
