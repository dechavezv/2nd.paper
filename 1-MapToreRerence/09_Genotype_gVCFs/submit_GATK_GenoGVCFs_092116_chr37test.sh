...
-stand_call_conf 0 \
-L chr37 \
$(for j in {01..15}; do echo "-V /u/scratch/j/jarobins/fox/vcfs/fox${j}_GATK_HC_BPR_chr37.g.vcf.gz "; done) \
-o /u/scratch/j/jarobins/fox/vcfs/fox01_15_joint_GATK_HC_BPR_chr37.vcf.gz
