...
-stand_call_conf 0 \
-L chr0$SGE_TASK_ID \
$(for j in {01..15}; do echo "-V /u/home/j/jarobins/project-rwayne/fox/vcfs/ind_gvcfs/fox${j}_GATK_HC_BPR_chr0$SGE_TASK_ID.g.vcf.gz "; done) \
-o /u/home/j/jarobins/project-rwayne/fox/vcfs/joint_vcfs/fox01_15_joint_GATK_HC_BPR_chr0$SGE_TASK_ID.vcf.gz 
