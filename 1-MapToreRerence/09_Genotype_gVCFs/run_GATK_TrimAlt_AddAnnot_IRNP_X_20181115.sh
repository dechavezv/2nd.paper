...
-R ${REFERENCE} \
-trimAlternates \
-V IRNP_44_joint_chrX_$(printf "%03d" "$SGE_TASK_ID").vcf.gz \
-o IRNP_44_joint_chrX_$(printf "%03d" "$SGE_TASK_ID")_TrimAlt.vcf.gz
...
-A VariantType \
-A AlleleBalance \
-V IRNP_44_joint_chrX_$(printf "%03d" "$SGE_TASK_ID")_TrimAlt.vcf.gz \
-o IRNP_44_joint_chrX_$(printf "%03d" "$SGE_TASK_ID")_TrimAlt_Annot.vcf.gz 
