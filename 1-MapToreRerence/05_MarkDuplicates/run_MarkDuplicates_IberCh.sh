...
#$ -o /u/scratch/d/dechavez/IberianChinese/log/mrkDup.out
#$ -e /u/scratch/d/dechavez/IberianChinese/log/mrkDup.err
#$ -m abe
#$ -M dechavezv
...
TEMP_DIR=/u/scratch/d/dechavez/IberianChinese/temp
BAM_DIR=/u/scratch/d/dechavez/IberianChinese
