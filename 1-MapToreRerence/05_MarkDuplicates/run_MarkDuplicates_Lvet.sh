...
#$ -l highmem,h_rt=18:00:00,h_data=25G,highp
#$ -o /u/home/d/dechavez/project-rwayne/Lvet/log/mrkDup.human.out
#$ -e /u/home/d/dechavez/project-rwayne/Lvet/log/mrkDup.human.err
#$ -m abe
#$ -M dechavezv
...
TEMP_DIR=/u/scratch/d/dechavez/Lvet/temp
