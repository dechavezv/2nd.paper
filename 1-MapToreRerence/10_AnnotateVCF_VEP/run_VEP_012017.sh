...
-i fox_15_joint_chr05_trim_annot_CpGRep_filtered.vcf.gz -o STDOUT \
--stats_file fox_15_joint_chr05_trim_annot_CpGRep_filtered_VEP_stats.html \
--sift b --species canis_familiaris --canonical --allow_non_variant --symbol --force_overwrite | \
$BGZIP > fox_15_joint_chr05_trim_annot_CpGRep_filtered_VEP.vcf.gz

$TABIX -p vcf fox_15_joint_chr05_trim_annot_CpGRep_filtered_VEP.vcf.gz
