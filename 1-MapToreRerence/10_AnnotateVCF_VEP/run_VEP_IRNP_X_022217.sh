...
-i IRNP_35_joint_chrX_TrimAlt.vcf.gz -o STDOUT \
--stats_file IRNP_35_joint_chr39_X_TrimAlt_VEP_stats.html \
--sift b --species canis_familiaris --canonical --allow_non_variant --symbol --force_overwrite | \
sed 's/ /_/g' | $BGZIP > IRNP_35_joint_chr39_X_TrimAlt_VEP.vcf.gz

$TABIX -p vcf IRNP_35_joint_chr39_X_TrimAlt_VEP.vcf.gz
