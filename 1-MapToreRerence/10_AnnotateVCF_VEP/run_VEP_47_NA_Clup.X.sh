...
-i NA_CLup_joint_chrX_TrimAlt_Annot_Mask_Filter.vcf.gz -o STDOUT \
--stats_file NA_CLup_joint_chrX_TrimAlt_Annot_Mask_Filter_VEP_stats.html \
--sift b --species canis_familiaris --canonical --allow_non_variant --symbol --force_overwrite | \
sed 's/ /_/g' | $BGZIP > NA_CLup_joint_chrX_TrimAlt_Annot_Mask_Filter_VEP.vcf.gz

$TABIX -p vcf NA_CLup_joint_chrX_TrimAlt_Annot_Mask_Filter_VEP.vcf.gz
