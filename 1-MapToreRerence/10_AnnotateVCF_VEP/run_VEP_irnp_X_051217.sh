...
-i IRNP_43_joint_chrX_TrimAlt_Annot.vcf.gz -o STDOUT \
--stats_file IRNP_43_joint_chrX_TrimAlt_Annot_VEP_stats.html \
--sift b --species canis_familiaris --canonical --allow_non_variant --symbol --force_overwrite | \
sed 's/ /_/g' | sed 's/<NON_REF>/N/g' | sed -E 's/\t\t/\t.\t/g' | \
$BGZIP > IRNP_43_joint_chrX_TrimAlt_Annot_VEP.vcf.gz

$TABIX -p vcf IRNP_43_joint_chrX_TrimAlt_Annot_VEP.vcf.gz
