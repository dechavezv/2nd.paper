...
for i in {23..35}; 
	...
	echo "#$ -l h_rt=24:00:00,h_data=8G,h_vmem=40G,arch=intel*"
	echo "#$ -t 01-8:1"
	echo "#$ -N HC_rail_${i}"
	...
	echo "-R /u/home/d/dechavez/project-rwayne/rails.project/reference.genomes/InaccesibleRail/chr_and_superScafolds/InaccesibleRail.chr.fa \\"
	...
	) > "run_GATK_HC_rail_chr23_35_highp.sh"

	qsub run_GATK_HC_rail_chr23_35_highp.sh
