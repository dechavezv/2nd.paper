...
for i in {01..12}; 
	...
	do (
	echo "#! /bin/bash"
	echo "#$ -wd /u/scratch/d/dechavez/YNP_4Genomes"
	echo "#$ -l h_rt=42:00:00,h_data=8G,highp,h_vmem=30G"
	echo "#$ -t 1-3:1"
	echo "#$ -N HC_BV_${i}"
	echo "#$ -o /u/scratch/d/dechavez/YNP_4Genomes/log/reports"
	echo "#$ -e /u/scratch/d/dechavez/YNP_4Genomes/log/reports"
	echo "#$ -m abe"
	echo "#$ -M dechavezv"
	echo
	...
	echo
	echo "cd /u/scratch/d/dechavez/YNP_4Genomes"
	echo 
	echo "export BAM=\$(ls \$(printf "%02d" "\$SGE_TASK_ID")_Clup*Aligned.MarkDup_Filtered.bam)"
	...
	echo "-L chr${i} \\"
	echo "-I \${BAM} \\"
	echo "-o /u/home/d/dechavez/project-rwayne/Clup/GVCF/YNP_RS/\${ID}_chr${i}.g.vcf.gz"
	
	) > "run_GATK_HC_4YNP_chr01_12_highp.sh"

	qsub run_GATK_HC_4YNP_chr01_12_highp.sh
