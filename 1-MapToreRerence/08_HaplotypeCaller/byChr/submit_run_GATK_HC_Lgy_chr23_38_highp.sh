...
for i in {23..38}; 
	...
	echo
	echo "export BAM=\$(ls Lgy\$(printf "%02d" "\$SGE_TASK_ID")_Aligned.MarkDup_Filtered.bam)"
	...
	echo "-L chr${i} \\"
	echo "-I \${BAM} \\"
	echo "-o /u/scratch/d/dechavez/Lgy/GVCFs/\${ID}_chr${i}.g.vcf.gz"
	
	) > "run_GATK_HC_Lgy_chr23_38_highp.sh"

	qsub run_GATK_HC_Lgy_chr23_38_highp.sh
