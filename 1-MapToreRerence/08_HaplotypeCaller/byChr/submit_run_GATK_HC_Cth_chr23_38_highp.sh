...
for i in {23..38}; 
	...
	do (
	echo "#! /bin/bash"
	echo "#$ -wd /u/home/d/dechavez/project-rwayne/Cth/reads"
	echo "#$ -l h_rt=24:00:00,h_data=8G,h_vmem=24G,arch=intel*"
	echo "#$ -N HC_BV_${i}"
	echo "#$ -o /u/home/d/dechavez/project-rwayne/Cth/reads/log/reports"
	echo "#$ -e /u/home/d/dechavez/project-rwayne/Cth/reads/log/reports"
	echo "#$ -m abe"
	echo "#$ -M dechavezv"
	echo
	...
	echo
	echo "cd /u/home/d/dechavez/project-rwayne/Cth/reads"
	echo 
	echo "export BAM=bCth_Aligned.MarkDup_Filtered.bam"
	...
	echo "-L chr${i} \\"
	echo "-I \${BAM} \\"
	echo "-o /u/home/d/dechavez/project-rwayne/Cth/GVCF/\${ID}_chr${i}.g.vcf.gz"
	
	) > "run_GATK_HC_Cth_chr23_38_highp.sh"

	qsub run_GATK_HC_Cth_chr23_38_highp.sh
