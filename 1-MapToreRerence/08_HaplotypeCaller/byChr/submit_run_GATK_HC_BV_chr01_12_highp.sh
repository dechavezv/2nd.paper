...
for i in {01..12}; 
	...
	echo "#$ -l h_rt=42:00:00,h_data=9G,highp,h_vmem=30G"
	echo "#$ -t 32-32:1"
	echo "#$ -N HC_BV_${i}"
	...
	echo
	echo "java -jar -Xmx9g /u/local/apps/gatk/3.7/GenomeAnalysisTK.jar \\"
	...
	) > "run_GATK_HC_BV_chr01_12_highp.sh"

	qsub run_GATK_HC_BV_chr01_12_highp.sh
