...
for i in {01..12}; 
	...
	do (
	echo "#! /bin/bash"
	echo "#$ -wd /u/home/d/dechavez/project-rwayne/Clup/reads/TG"
	echo "#$ -l h_rt=42:00:00,h_data=10G,highp,h_vmem=30G"
	echo "#$ -t 01-2:1"
	echo "#$ -N HC_TG_${i}"
	echo "#$ -o /u/home/d/dechavez/project-rwayne/Clup/reads/TG/log/reports"
	echo "#$ -e /u/home/d/dechavez/project-rwayne/Clup/reads/TG/log/reports"
	echo "#$ -m abe"
	echo "#$ -M dechavezv"
	echo
	...
	echo "-L chr${i} \\"
	echo "-I \${BAM} \\"
	echo "-o /u/home/d/dechavez/project-rwayne/Clup/GVCF/TG/\${ID}_chr${i}.g.vcf.gz"
	
	) > "run_GATK_HC_TG_chr01_12_highp.sh"

	qsub run_GATK_HC_TG_chr01_12_highp.sh
