...
for f in 14_12 15_06 15_10 16_03 16_07 17_08 17_09 20_06 20_15 22_09; 

	do (
	echo "#! /bin/bash"
	echo "#$ -wd /u/scratch/j/jarobins/fox"
	echo "#$ -l h_rt=24:00:00,h_data=21G,arch=intel-E5-2670,highp"
	echo "#$ -N HC_re${f}"
	...
	) > "submit_GATK_HC_100416_redo8highp.sh"

	qsub submit_GATK_HC_100416_redo8highp.sh
