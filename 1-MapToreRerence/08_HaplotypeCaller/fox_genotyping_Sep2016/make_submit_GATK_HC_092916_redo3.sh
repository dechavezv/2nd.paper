...
for f in 29_13 29_14 29_15 30_04 30_05 30_06 30_07 30_09 30_11 30_12 30_13 30_14 31_01 31_02 31_03 31_04 32_09 32_10 32_11 32_12 32_13 32_15 33_01 33_03 33_04 33_05 33_07 33_08 33_09 33_10 33_11 33_12; 

	do (
	echo "#! /bin/bash"
	echo "#$ -wd /u/scratch/j/jarobins/fox"
	echo "#$ -l h_rt=24:00:00,h_data=21G,arch=intel*"
	echo "#$ -N HC_re${f}"
	...
	) > "submit_GATK_HC_092916_redo3.sh"

	qsub submit_GATK_HC_092916_redo3.sh
