...
for f in 05_10 06_04; 

	do (
	echo "#! /bin/bash"
	echo "#$ -wd /u/scratch/j/jarobins/fox"
	echo "#$ -l h_rt=40:00:00,h_data=21G,arch=intel-E5-2670,highp"
	echo "#$ -N HC_re${f}"
	...
	) > "submit_GATK_HC_100316_redo7highp.sh"

	qsub submit_GATK_HC_100316_redo7highp.sh
