...
#$ -t 1-15:1
#$ -N HC_fox18
#$ -o /u/scratch/j/jarobins/HC_fox18.out
#$ -e /u/scratch/j/jarobins/HC_fox18.err
#$ -m abe
#$ -M jarobins
...
-o /u/scratch/j/jarobins/fox/vcfs/fox$(printf %02d $SGE_TASK_ID)_GATK_HC_BPR_chr18.g.vcf.gz
