...
#$ -l highmem,h_rt=17:00:00,h_data=20G,highp,h_vmem=24G
#$ -o /u/home/d/dechavez/project-rwayne/Clup/reads/TG/log/MarkIlAd
#$ -e /u/home/d/dechavez/project-rwayne/Clup/reads/TG/log/MarkIlAd
#$ -m abe
#$ -M dechavezv
#$ -N MrkIlAd
