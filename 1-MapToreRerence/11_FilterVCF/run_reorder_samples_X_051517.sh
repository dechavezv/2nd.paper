...
-L chrX \
-V /u/scratch2/j/jarobins/irnp/joint_vcfs/IRNP_43_joint_chrX_TrimAlt_Annot_VEP_Masked_rename.vcf.gz \
-o /u/scratch2/j/jarobins/irnp/joint_vcfs/IRNP_43_joint_chrX_TrimAlt_Annot_VEP_Masked_rename_reorder.vcf.gz 
