...
#$ -o /u/scratch/d/dechavez/Ethiopian/VCF/log/
#$ -e /u/scratch/d/dechavez/Ethiopian/VCF/log/
#$ -m abe
#$ -M dechavezv
...
IDX=X
VCF=Csmi01_chr${IDX}_TrimAlt_Annot.vcf.gz
...
SCRIPT=/u/home/d/dechavez/project-rwayne/2nd.paper/1-MapToreRerence/11_FilterVCF/scripts/filterVCF_Eth.py
