...
#$ -o /u/home/d/dechavez/project-rwayne/Lculp/VCF/VCF/log/
#$ -e /u/home/d/dechavez/project-rwayne/Lculp/VCF/log/
#$ -m abe
#$ -M dechavezv
...
IDX=X
VCF=Lculp01_chr${IDX}_TrimAlt_Annot.vcf.gz
...
SCRIPT=/u/home/d/dechavez/project-rwayne/2nd.paper/1-MapToreRerence/11_FilterVCF/scripts/filterVCF_Lculp.py
