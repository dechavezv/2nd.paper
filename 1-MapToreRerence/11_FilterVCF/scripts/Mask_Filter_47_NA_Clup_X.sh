...
#$ -l highp,h_rt=24:00:00,h_data=7G,arch=intel*,h_vmem=30G
#$ -N Filter.VCF
#$ -o /u/home/d/dechavez/project-rwayne/Clup/VCF
#$ -e /u/home/d/dechavez/project-rwayne/Clup/VCF
#$ -m abe
#$ -M dechavezv
...
SCRIPT=/u/home/d/dechavez/project-rwayne/2nd.paper/1-MapToreRerence/11_FilterVCF/scripts/filterVCF_47_NA_Clup.py
