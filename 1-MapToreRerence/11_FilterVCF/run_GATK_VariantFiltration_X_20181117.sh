...
-L chrX \
-V IRNP_44_joint_chrX_TrimAlt_Annot_VEP.vcf.gz \
-o IRNP_44_joint_chrX_TrimAlt_Annot_VEP_Masked.vcf.gz
...
VCF=IRNP_44_joint_chrX_TrimAlt_Annot_VEP_Masked.vcf.gz
